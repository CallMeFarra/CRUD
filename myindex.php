...
<html>
    ...
    <body>
        ...
        <table border = "1" class="table">
            <tr class="tanda">
                <th>NO</th> <th>NIM</th> <th>NAMA</th> <th>JENIS KELAMIN</th> <th>JURUSAN</th><th>ACTION</th>
            </tr>
    ...
    <body>
        <nav>
            <h2 class="header">Sistem Informasi Wali</h2>
            <nav class="background">
                <a href="wali.php">Home</a>
                <a href="form-input.php">Mahasiswa</a>
                <a href="home.php">Admin</a>
        ...
        <table border = "1" class="table">
            <tr class="tanda">
                <th>NO</th><th>NAMA</th> <th>JENIS KELAMIN</th><th>ALAMAT</th><th>ACTION</th>
            </tr>
            ...
            include 'koneksi.php';
            // $mahasiswa = mysqli_query($koneksi, "SELECT * from data_mahasiswa");
            $data_wali = mysqli_query($koneksi, "SELECT * from data_wali");
            $no = 1;

            foreach ($data_wali as $row){
                $jenis_kelamin = $row['jenis_kelamin']=='P'?'Perempuan':'Laki laki';
                echo "<tr>
                        <td>$no</td>
                        <td>".$row['nama']."</td>
                        ...
                        <td>
                            <a href='edit-wali.php?id_wali=$row[id_wali]'>Edit</a>
                            <a href='delete-wali.php?id_wali=$row[id_wali]'>Delete</a>
                        </td>
                    </tr>";
                $no++;
            }
        ...
        <p></p>
        <button>
            <a href="wali.php">Masukkan data lainnya</a>
        </button>
        <footer>
